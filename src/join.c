...
// Functions
//*****************************************************************************
void create_join_database(employee_data* employee_data_array, uint32_t num_employees) {
    for(uint32_t i = 0; i < num_employees; i++) {
...
void run_join_operation(trip_data* trip_array, uint32_t num_trips) {
...
void print_joined_database(uint32_t num_employees) {
